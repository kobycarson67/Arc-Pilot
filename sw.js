...
const CORE=['./','./index.html','./app.webmanifest','./app-build.js','./icons/icon-192.png','./icons/icon-512.png','./src/arc_visual_foundation.css','./src/app_update_controller.js','./src/project_checkpoints.js','./src/project_checkpoint_controller.js','./src/project_checkpoint_presenter.js','./src/project_tab_adapter.js','./src/project_checkpoint_persistence.js','./src/project_checkpoint_host_bridge.js','./src/project_checkpoint_card.js','./src/project_bank.js','./src/booth_assignment_lifecycle.js','./src/class_forecast.js','./src/teaching_tips.js','./src/inventory.js','./src/deployment_readiness.js'];
