...
const updates=fs.readFileSync('src/app_update_controller.js','utf8');
...
assert(updates.includes("type:'SKIP_WAITING'"),'host must apply a waiting update intentionally');
