...
['index.html','sw.js','app-build.js','src/project_bank.js','src/booth_assignment_lifecycle.js','src/app_update_controller.js'].forEach(asset=>assert(workflow.includes(asset),'guardrail must compare '+asset));
