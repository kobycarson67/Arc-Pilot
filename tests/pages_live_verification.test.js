...
['index.html','sw.js','app-build.js','app.webmanifest','src/arc_titanium_visual_system.css','src/arc_titanium_visual_refinement_1.css','src/arc_icons.js','assets/brand/runtime/arc-welding-dashboard-hero-1440.webp','assets/brand/runtime/arc-titanium-industrial-background-1440.webp','assets/brand/runtime/arc-welding-primary-logo-960.png','assets/brand/runtime/arc-welding-lettermark-720.png','icons/favicon-32.png','icons/apple-touch-icon-180.png','icons/icon-192.png','icons/icon-512.png','icons/icon-maskable-192.png','icons/icon-maskable-512.png','src/project_bank.js','src/booth_assignment_lifecycle.js','src/class_forecast.js','src/simulation_foundation.js','src/simulation_fixtures.js','src/material_inventory.js','src/material_inventory_presenter.js','src/material_inventory_modal_lifecycle.js','src/app_update_controller.js'].forEach(asset=>assert(workflow.includes(asset),'guardrail must compare '+asset));
